...
export default function PhotoBox(data) {
    data={name:"me",age:12,description:"We love puppies!",image:'http://farm66.staticflickr.com/65535/50086454436_1a18d65619.jpg'}
    return (
        <li>
            <div className="photo">
                ...
                <img className="photo-img" src={data.image}></img>
